        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8 border border-neutral-border">
          <div className="space-y-2">
            ...
            <p className="text-sm text-neutral">
              ...
              или DOCX документ без четимо текстово съдържание. За да можем да
              обработим тези съобщения, институциите трябва да публикуват
              съдържанието директно в текстов вид.
            </p>
          </div>
        </div>
