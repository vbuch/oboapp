...
- **Full Pipeline** (`pipeline:all`) - 3 times daily (10:00, 14:00, 16:00 EET)
  - Crawlers: All sources (rayon-oborishte-bg, rayon-pancharevo-bg, rayon-ilinden-bg, sofia-bg, mladost-bg, studentski-bg, sredec-sofia-org, so-slatina-org, lozenets-sofia-bg, raioniskar-bg, nimh-severe-weather, plus emergent crawlers)
  - Runs ingest and notify after crawling
