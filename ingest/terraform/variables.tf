...
variable "schedules" {
  ...
  type = object({
    ...
    crawl_mladost         = string
    crawl_studentski      = string
    ingest                = string
    notify                = string
  })
  default = {
    ...
    crawl_mladost         = "25 10,14,16 * * *"  # 3x daily: 10:25, 14:25, 16:25
    crawl_studentski      = "27 10,14,16 * * *"  # 3x daily: 10:27, 14:27, 16:27
